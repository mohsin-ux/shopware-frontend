...
<template>
  <div class="bg-[#EEEDE8] sticky bottom-0">
    <SideBarMenu :isShowMenu="isShowMenu" @showMenu="toggleShowMenu" />
    ...
    <div class="sm:p-4">
      ...
      >
        <div class=" p-2 w-full flex justify-center sm:hidden" @click="toggleShowMenu" :class="{ hidden: isShowMenu }">
